...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Parul university</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Parul university</h1>
			<!-- Icon Divider-->
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">what do you wish to checkout today!</h2>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">This website is built as a part of practical 5 which is to use jsp</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Div 5B03</p>
				</div>
			</div>
